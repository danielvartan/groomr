...
First of all, thanks for considering contributing to `groomr`! 👍 It’s
people like you that make it rewarding for us - the project
maintainers - to work on `groomr`. 😊

`groomr` is an open source project, maintained by people who care. We
are not directly funded to do so.

## Code of conduct

Please note that this project is released with a [Contributor Code of
Conduct](https://danielvartan.github.io/groomr/CODE_OF_CONDUCT.md). By
...
Think `groomr` is useful? Let others discover it, by telling them in
person, via Twitter or a blog post.

Using `groomr` for a paper you are writing? Consider [citing
it](https://danielvartan.github.io/groomr/authors.html).

### Ask a question ⁉️

Using `groomr` and got stuck? Browse the
[documentation](https://danielvartan.github.io/groomr) to see if you can
find a solution. Still stuck? Post your question as an [new discussion
on GitHub](https://github.com/danielvartan/groomr/discussions/new).
While we cannot offer user support, we’ll try to do our best to address
it, as questions often lead to better documentation or the discovery of
bugs.
...
Have an idea for a new `groomr` feature? Take a look at the
[documentation](https://danielvartan.github.io/groomr) and [discussion
list](https://github.com/danielvartan/groomr/discussions) to see if it
isn’t included or suggested yet. If not, suggest your idea as an
[discussion on
GitHub](https://github.com/danielvartan/groomr/discussions/new). While
...
Using `groomr` and discovered a bug? That’s annoying! Don’t let others
have the same experience and report it as an [issue on
GitHub](https://github.com/danielvartan/groomr/issues/new) so we can fix
...
- Any details about your local setup that might be helpful in
  troubleshooting.
- Detailed steps to reproduce the bug (tip: use
...
[This website](https://danielvartan.github.io/groomr) is generated with
...
to improve documentation. If not, [start a
discussion](https://github.com/danielvartan/groomr/discussions/new) so
...
1.  Go to `R/` directory in the [code
    repository](https://github.com/danielvartan/groomr).
...
Care to fix bugs or implement new functionality for `groomr`? Awesome!
👏 Have a look at the [issue
list](https://github.com/danielvartan/groomr/issues) and leave a comment
...
1.  Fork [this repo](https://github.com/danielvartan/groomr) and clone
...
Also note that we use the [tidyverse design
guide](https://principles.tidyverse.org/) and [tidyverse style
guide](https://style.tidyverse.org/). Your code must conform to this
